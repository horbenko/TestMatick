...
public class ColorUtils {
    ...
    /**
     * Get the closest color name from initialized color list.
     *
     * @param r the Red component
     * @param g the Green component
     * @param b the Blue component
     * @return nearest color name from the initColorList
     */
    ...
    /**
     * SubClass of ColorUtility.ColorUtils. In order to lookup color name
     */
